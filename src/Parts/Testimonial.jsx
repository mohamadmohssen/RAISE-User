...
const Testimonial = () => {
  ...
  const testimonials = [
    {
      id: 1,
      name: t("Sarah M., Mother of a 4-year-old"),
      message: t(
    ...
    {
      id: 2,
      name: t("Dr. Emily R., Speech-Language Pathologist"),
      message: t(
    ...
    {
      id: 3,
      name: t("John D., Father of a 3-year-old"),
      message: t(
        ...
        <div className="row justify-content-center">
          <div className="col-lg-7">
            <div className="section-title text-center">
              <h2>{t("We served over 5000+ Patients")}</h2>
